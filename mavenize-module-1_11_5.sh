...
echo "Replacing id, name, version, package and require_version with properties"
...
sed -i '0,/<require_version>[^<]*<\/require_version>/s//<require_version>${openMRSVersion}<\/require_version>/' omod/src/main/resources/config.xml
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<artifactId>${SH_MOD_ID}-omod</artifactId>
